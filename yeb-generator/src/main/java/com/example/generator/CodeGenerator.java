...
public class CodeGenerator {
    public static void main(String[] args) {
        ...
        dataSourceConfig.setPassword("Bxyssz724");
        dataSourceConfig.setUrl("jdbc:mysql://47.102.217.84:3306/yeb?useUnicode=true&characterEncoding=UTF-8");
